...
epsilon_std = 0.5  # Exploration noise
np.random.seed(42)
...
# Create simulations
sd_simulation = Simulation(plant_1, sd_controller, x0, sim_time, h_sim, random_seed=42)
dd_simulation = Simulation(plant_2, dd_controller, x0, sim_time, h_sim, epsilon_std=epsilon_std, random_seed=42)
ddsd_simulation = Simulation(plant_3, ddsd_controller, x0, sim_time, h_sim, epsilon_std=epsilon_std, w_std=w_std, random_seed=42)
